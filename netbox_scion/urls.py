...
urlpatterns = (
    ...
    path('organizations/<int:pk>/changelog/', views.OrganizationChangeLogView.as_view(model=models.Organization), name='organization_changelog'),
    ...
    path('isd-ases/<int:pk>/changelog/', views.ISDAChangeLogView.as_view(model=models.ISDAS), name='isdas_changelog'),
    ...
    path('link-assignments/<int:pk>/changelog/', views.SCIONLinkAssignmentChangeLogView.as_view(model=models.SCIONLinkAssignment), name='scionlinkassignment_changelog'),
)
